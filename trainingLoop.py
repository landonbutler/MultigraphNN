...
# returns (average RMSE, number of parameters)
def training_loop(arch_type, architecture, lossFunction, xTrain, yTrain, xValid, yValid, xTest, yTest, device, sparse = False, nEpochs = 200, learningRate = 0.05, batchSize = 20, classes = None, verbose = True, evalFunction = None): 
